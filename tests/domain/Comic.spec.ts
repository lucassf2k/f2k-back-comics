...
describe('Comic Test', () => {
  ...
  test('should update name, synopsis, authorName, path and coverPath', async () => {
    const sut = new Comic(comicProps)
    ...
    sut.updatePath('sadadad')
    sut.updateCoverPath('sadadada.jpeg')
    ...
    expect(sut.path).toStrictEqual('sadadad')
    expect(sut.coverPath).toStrictEqual('sadadada.jpeg')
  })

  test('should update path and coverPath if path and cover is not empty', async () => {
    const sut = new Comic(comicProps)
    sut.updateName('A Estrela que não brilha')
    sut.updateSynopsis('Uma garota que vive..')
    sut.updateAuthorName(new Name('Lucas Fernandes'))
    sut.addComicPath('sadadad')
    sut.addComicCoverPath('sadadada.jpeg')
    sut.updatePath('')
    sut.updateCoverPath('')
    expect(sut.name).toStrictEqual('A Estrela que não brilha')
    expect(sut.synopsis).toStrictEqual('Uma garota que vive..')
